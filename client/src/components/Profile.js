      ...
      <div className="bg-gray-100 h-screen">
        ...
        <div className="sm:pt-32 pt-40 px-8">
          ...
          <div className="inline px-8">
            {props.profile.isLoading ? "Loading" : profile && profile.info.photo ?
              <img
            ...
            {props.profile.isLoading ? "Loading" : profile && profile ?
              <>
              ...
              : "Not found"}
            <h1 className="text-black text-base font-semibold border-border border-b-2 mt-4">Status</h1>

            <h1 className="text-black text-base font-semibold border-border border-b-2 mt-4">Jasa</h1>
            {props.profile.isLoading ? "Loading" : profile && profile.products ?
